...
public class CardRow {
    ...
    private List<MultiplexImage> mImage;

    public List<MultiplexImage> getmImage() {
        return mImage;
    }

    public void setmImage(List<MultiplexImage> mImage) {
        this.mImage = mImage;
    }

    public CardRow(String title, List<Card> cards){
        mTitle = title;
        mCards = cards;
    }
    public int getType() {
